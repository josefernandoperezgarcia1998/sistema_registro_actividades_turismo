...
@section('title_page', 'Editar empleado')
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="area-search" name="area_id">
                                    <option value="{{ $empleado->area_id }}" selected="selected">
                                        {{ $empleado->area->nombre }}</option>
                                </select>
                                @error('area_id')
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <select class="form-select w-50" name="estado">
                                    ...
                                    <option {{ old('estado') == 'Si' ? 'selected' : ($empleado->estado == 'Si' ? 'selected' : '') }} value="Si">Si</option>
                                    <option {{ old('estado') == 'No' ? 'selected' : ($empleado->estado == 'No' ? 'selected' : '') }} value="No">No</option>
                                </select>
                            </div>
                        </div>
                    </div>
