...
@section('title_page', 'Catálogo de servicios')
...
<div class="card shadow p-3 mb-5 bg-body rounded">
    <div class="carrd-header">
        <div class="d-flex justify-content-between">
            ...
            <a href="{{route('catalogo-servicios.create')}}" class="btn btn-primary btn-sm">Nueva servicio</a>
        </div>
    </div>
    <div class="card-body">
        <table class="table" id="catServiciosTable">
            <thead>
                <tr>
                    <th>Nombre</th>
                    <th>Activo</th>
...
$(document).ready(function () {
    $('#catServiciosTable').DataTable({
        "serverSide": true,
        "ajax": "{{ url('catalogo-servicios-data') }}",
        "columns": [
            {data: 'nombre'},
            {data: 'estado'},
            {data: 'btn'},
